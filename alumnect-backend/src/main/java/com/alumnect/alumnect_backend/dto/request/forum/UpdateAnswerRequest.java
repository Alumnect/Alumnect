...
/**
 * DTO chứa dữ liệu yêu cầu chỉnh sửa một câu trả lời trên diễn đàn Q&A (UC48 - Edit an answer).
 * Chỉ cho phép sửa nội dung; quyền sở hữu (chỉ tác giả) được kiểm tra ở tầng Service.
 */
@Data
@Builder
@NoArgsConstructor
