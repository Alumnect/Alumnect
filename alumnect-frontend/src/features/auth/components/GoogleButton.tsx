    ...
    <div className="w-full flex flex-col items-center gap-3">
      <div className="w-full flex justify-center min-h-[48px]">
        {googleLoginMutation.isPending ? (
          <div className="flex h-12 w-full items-center justify-center gap-3 rounded-xl border border-plum-900/15 bg-white text-sm font-semibold text-plum-800">
          ...
          <div ref={containerRef} className="w-full flex justify-center" id="google-signin-btn-container" />
        )}
      </div>
