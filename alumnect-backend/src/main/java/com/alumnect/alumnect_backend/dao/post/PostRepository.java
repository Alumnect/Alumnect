...
/**
 * Repository quản lý các thao tác dữ liệu trên bảng posts (Bài viết bảng tin
 * cộng đồng).
 */
@Repository
public interface PostRepository extends JpaRepository<Post, Long>, JpaSpecificationExecutor<Post> {
    ...
    /**
     * Lấy một trang bài viết cho bảng tin cộng đồng (UC15 - View community Feed),
     * đã áp dụng:
     * <ul>
     * <li>Loại trừ bài viết đã bị ẩn (isHidden = true) — BR-08/BR-11.</li>
     * <li>Nếu người xem là Guest (guestMode = true), chỉ trả về bài viết PUBLIC —
     * BR-12.</li>
     * <li>Lọc theo loại bài viết nếu {@code type} khác null.</li>
     * <li>Sắp xếp theo thời gian tạo mới nhất trước (JOIN FETCH tác giả để tránh
     * N+1 query).</li>
     * </ul>
     *
     * @param guestMode true nếu người xem là Guest (chưa đăng nhập), false nếu đã
     *                  đăng nhập
     ...
     * @return Trang kết quả các bài viết khớp điều kiện, đã kèm sẵn thông tin tác
     *         giả (User)
     */
     ...
     * quyền xem (BR-08/BR-11/BR-12) do tầng Service xử lý để trả đúng mã lỗi
     * 404/403.
     *
